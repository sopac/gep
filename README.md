# GEP Resource Mobilsation Toolkit

## Georesources and Energy Programme, Pacific Community (SPC)
...
To build the final jar and optimize the gep application for production, run:
