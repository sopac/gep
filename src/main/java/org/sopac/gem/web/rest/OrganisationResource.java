...
/**
 * REST controller for managing {@link org.sopac.gem.domain.Organisation}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingOrganisation -> {
                    ...
                    if (organisation.getAcronym() != null) {
                        existingOrganisation.setAcronym(organisation.getAcronym());
                    }
                    if (organisation.getOrganisationCategory() != null) {
                        existingOrganisation.setOrganisationCategory(organisation.getOrganisationCategory());
                    }
                    if (organisation.getUrl() != null) {
                        existingOrganisation.setUrl(organisation.getUrl());
                    }
