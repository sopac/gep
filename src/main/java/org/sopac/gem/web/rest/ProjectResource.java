...
/**
 * REST controller for managing {@link org.sopac.gem.domain.Project}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Project> result = projectRepository
            ...
            .map(
                existingProject -> {
                    ...
                    if (project.getTotalBudgetCurrency() != null) {
                        existingProject.setTotalBudgetCurrency(project.getTotalBudgetCurrency());
                    }
                    if (project.getTotalBudget() != null) {
                        existingProject.setTotalBudget(project.getTotalBudget());
                    }
                    if (project.getTotalBudgetBreakdown() != null) {
                        existingProject.setTotalBudgetBreakdown(project.getTotalBudgetBreakdown());
                    }
                    if (project.getSustainableDevelopmentGoal() != null) {
                        existingProject.setSustainableDevelopmentGoal(project.getSustainableDevelopmentGoal());
                    }
                    if (project.getFrameworkResilientDevelopmentPacific() != null) {
                        existingProject.setFrameworkResilientDevelopmentPacific(project.getFrameworkResilientDevelopmentPacific());
                    }
                    if (project.getFullCostRecoveryCoverage() != null) {
                        existingProject.setFullCostRecoveryCoverage(project.getFullCostRecoveryCoverage());
                    }
