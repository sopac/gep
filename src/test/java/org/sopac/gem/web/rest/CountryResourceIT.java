...
class CountryResourceIT {
    ...
    private static final Boolean DEFAULT_MEMBER = false;
    private static final Boolean UPDATED_MEMBER = true;
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().name(DEFAULT_NAME).member(DEFAULT_MEMBER);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().name(UPDATED_NAME).member(UPDATED_MEMBER);
        return country;
    }
    ...
    void createCountry() throws Exception {
        ...
        assertThat(testCountry.getMember()).isEqualTo(DEFAULT_MEMBER);
    }
    ...
    void getAllCountries() throws Exception {
        ...
        restCountryMockMvc
            ...
            .andExpect(jsonPath("$.[*].member").value(hasItem(DEFAULT_MEMBER.booleanValue())));
    }
    ...
    void getCountry() throws Exception {
        ...
        restCountryMockMvc
            ...
            .andExpect(jsonPath("$.member").value(DEFAULT_MEMBER.booleanValue()));
    }
    ...
    void putNewCountry() throws Exception {
        ...
        updatedCountry.name(UPDATED_NAME).member(UPDATED_MEMBER);
        ...
        assertThat(testCountry.getMember()).isEqualTo(UPDATED_MEMBER);
    }
    ...
    void fullUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.name(UPDATED_NAME).member(UPDATED_MEMBER);
