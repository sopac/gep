...
class OrganisationResourceIT {
    ...
    private static final OrganisationCategory DEFAULT_ORGANISATION_CATEGORY = OrganisationCategory.CROP;
    private static final OrganisationCategory UPDATED_ORGANISATION_CATEGORY = OrganisationCategory.ISSAC;
    ...
    public static Organisation createEntity(EntityManager em) {
        Organisation organisation = new Organisation()
            ...
            .organisationCategory(DEFAULT_ORGANISATION_CATEGORY)
            .url(DEFAULT_URL);
        return organisation;
    }
    ...
    public static Organisation createUpdatedEntity(EntityManager em) {
        Organisation organisation = new Organisation()
            ...
            .organisationCategory(UPDATED_ORGANISATION_CATEGORY)
            .url(UPDATED_URL);
        return organisation;
    }
    ...
    void createOrganisation() throws Exception {
        ...
        assertThat(testOrganisation.getAcronym()).isEqualTo(DEFAULT_ACRONYM);
        assertThat(testOrganisation.getOrganisationCategory()).isEqualTo(DEFAULT_ORGANISATION_CATEGORY);
        assertThat(testOrganisation.getUrl()).isEqualTo(DEFAULT_URL);
    }
    ...
    void getAllOrganisations() throws Exception {
        ...
        restOrganisationMockMvc
            ...
            .andExpect(jsonPath("$.[*].organisationCategory").value(hasItem(DEFAULT_ORGANISATION_CATEGORY.toString())))
    ...
    void getOrganisation() throws Exception {
        ...
        restOrganisationMockMvc
            ...
            .andExpect(jsonPath("$.organisationCategory").value(DEFAULT_ORGANISATION_CATEGORY.toString()))
    ...
    void putNewOrganisation() throws Exception {
        ...
        assertThat(testOrganisation.getAcronym()).isEqualTo(UPDATED_ACRONYM);
        assertThat(testOrganisation.getOrganisationCategory()).isEqualTo(UPDATED_ORGANISATION_CATEGORY);
        assertThat(testOrganisation.getUrl()).isEqualTo(UPDATED_URL);
    }
